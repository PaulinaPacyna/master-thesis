...
\noindent \textbf{Keywords:} time series, classification, transfer learning, deep learning, ensemble, convolutional networks, multi-source transfer learning, fine-tuning \end{abstract}
}
...
\noindent \textbf{Słowa kluczowe:} szeregi czasowe, klasyfikacja, transfer learning, uczenie głębokie, modele ensemble, sieci splotowe, wieloźródłowe metody transfer learningu
\end{abstract}
}
...
Learning rate  used for finetuning                  & 1e-5 with 0.75 decay over 10 000 steps (exponential decay) \\ \hline
Learning rate  used for pre-training                  & 1e-4 with 0.96 decay over 10 000 steps (exponential decay) \\ \hline
