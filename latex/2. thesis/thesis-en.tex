...
%Given a dataset  $D = {(X_i, y_i)}_{i=1}^N$, where $X_i \in 2^R$ is a time series and $y_i\in {1, ..., N} = C$, we would like to find a function (called classifier) $f_\theta :2^R \leftarrow C$ such that 
%$$f_\theta (X_i) = y_i$$. 
