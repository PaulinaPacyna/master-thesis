...
\begin{figure}[h!t]
\centering
\includegraphics[width=12cm]{imgs/results/baseline/acc.png}
\caption{Averaged accuracy obtained from transfer learning with the \textit{baseline} approach, compared to a single FCN trained only on the target dataset.}
...
\begin{figure}[h!t]
\centering
\includegraphics[width=12cm]{imgs/results/baseline/loss.png}
\caption{Averaged loss obtained from transfer learning with the \textit{baseline} approach, compared to a single FCN trained only on the target dataset.}
\label{fig:baseline_loss}
\end{figure}
\FloatBarrier
The greatest improvement is visible in the first epochs of the training process. %TODO why
