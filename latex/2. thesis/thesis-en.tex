...
We also provided technical details on the code structure, preprocessing steps, model architecture, and hyperparameters. We conducted the analysis using the Fully Convolutional Network and used standard preprocessing steps like normalization or resampling. We utilized the property of the Fully Convolutional Network, which makes it possible to use different input lengths in every batch by implementing a custom Keras \texttt{DataGenerator}.
...
%2. TODO Proszę dodać pełne dane bibliograficzne do wszytskich pozycji z linkami DOI jeśli są dostępne.
