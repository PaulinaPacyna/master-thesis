...
\subsection{Fully Connected Networks}\label{FCN}
Fully Convolutional Networks are convolutional network used in time series classification \cite{dl_tsc}. FCN networks consists of blocks of convolutional layers proceeded by global pooling over the time axis and a dense layer. Because the architecture convolutional layers does not depend on the size of input data and the convolutional layer are followed by pooling over the time axis, the whole networks is capable of processing data of variable lengths.
