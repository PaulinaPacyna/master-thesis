...
\begin{figure}[h!t]
\centering
\includegraphics[width=8 cm]{imgs/results/baseline/acc.png}
\includegraphics[width=8cm]{imgs/results/baseline/loss.png}
...
\begin{figure}[h!t]
\centering
\includegraphics[width=7cm]{imgs/results/baseline/win_tie_lose_epoch_5.png}
\includegraphics[width=7cm]{imgs/results/baseline/win_tie_lose_epoch_10.png}
