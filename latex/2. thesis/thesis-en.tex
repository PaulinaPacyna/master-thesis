...
\noindent \textbf{Keywords:} time series, classification, transfer learning, deep learning, ensemble, convolutional networks, multi-source transfer learning, fine-tuning,  \ldots % TODO ask supervisor why.. the template also has ", ..." at the end
\end{abstract}
}
...
\noindent \textbf{Słowa kluczowe:} szeregi czasowe, klasyfikacja, transfer learning, uczenie głębokie, modele ensemble, sieci splotowe, wieloźródlowe metody transfer learningu,  \ldots
\end{abstract}
}
