...
\textbf{Distribution 1}  & \textbf{Distribution 2}   & \textbf{alternative}  & \multicolumn{2}{|l|}{\textbf{pvalue}} \\ \midrule
\textbf{Distribution 1}  & \textbf{Distribution 2}   & \textbf{alternative}  & {\textbf{Wilcoxon}} & {\textbf{T-test}} \\ \midrule

Baseline                                & no transfer learning  & greater & 0.3 & 0.04\\
\bottomrule
%\end{singlespace}
\end{tabular}
}
