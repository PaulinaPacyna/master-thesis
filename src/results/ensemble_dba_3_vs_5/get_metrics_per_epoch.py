...
class NumberOfDatasets(Results):
    ...
    distribution_names = ("5 datasets", "3 datasets")
    ...
    second_result_key_name_loss = "3_ensemble_loss"
    second_result_key_name_val_loss = "3_ensemble_val_loss"
    second_result_key_name_acc = "3_ensemble_accuracy"
    second_result_key_name_val_acc = "3_ensemble_val_accuracy"
    ...
    x_label_win_tie_loss = "using 3 source datasets"
    ...
    def _get_second_experiment_runs(self) -> Dict[str, Run]:
        hist = self._get_history_per_experiment(
            self.second_experiment_id, add_prefix="3_"
        )
        return hist
    ...
    def _prepare_legend(self, text: str):
        mapping = {
            ...
            self.second_result_key_name_loss: "Ensemble with 3 datasets \n- loss - train split",
            self.second_result_key_name_val_loss: "Ensemble with 3 datasets \n- loss - validation split",
            self.second_result_key_name_acc: "Ensemble with 3 datasets \n- accuracy - train split",
            self.second_result_key_name_val_acc: "Ensemble with 3 datasets \n- accuracy - validation split",
...
results = NumberOfDatasets(
    ...
    second_experiment_id="879346711569312185",
